...
See what expression is on their face after. Is it interested and excited? Or is it confusion, leaning disgusted? Many AI builders learn this lesson the hard way: AI cannot replace the human touch where it's most important: understanding and communicating risk.
...
This is the real reason developers are so valuable. It's not because you can code really well, or that you know how to do it right or fast. It's 100% because you know right from wrong. The average junior would look at this block of code and ship it:
...
The other day, the best engineer I've ever worked with took down prod for 20 minutes with a very subtle change because the AI did the complete opposite of what he said but it was hard to see it because he was unfamiliar with firewall rules. He posted an apology (which is unnecessary - others reviewed the code) and admitted he wasn't sure how to do something so he asked AI. Once the problem was spotted, we reverted quickly and everything resolved. We'll do a post-mortem and learn as a team. I myself have been responsible for a couple of these, but I'm thankful for the lessons: Next time we deal with firewall rules we're going to be a lot more knowledgeable.
